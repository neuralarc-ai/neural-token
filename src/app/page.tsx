                            ...
                            <div key={apiKey.id} className="group bg-card border-2 border-black shadow-neo-sm rounded-lg p-4 transition-all hover:shadow-neo flex flex-col justify-between">
                              ...
                              <div className="mt-3 flex gap-2">
                                <Button
                                  variant="outline"
                                  size="sm"
                                  className="flex-1 text-sm border-2 border-black shadow-neo-sm hover:shadow-neo active:shadow-none font-medium"
                                  onClick={() => fullKeyData && handleOpenViewApiKeyDialog(fullKeyData)}
                                >
                                  <Eye className="mr-1.5 h-4 w-4" /> View Key
                                </Button>
                                <Button
                                  variant="outline"
                                  size="sm"
                                  className="flex-1 text-sm border-2 border-black shadow-neo-sm hover:shadow-neo active:shadow-none font-medium bg-secondary hover:bg-secondary/80"
                                  onClick={() => fullKeyData && openTokenEntryDialogForApiKey(fullKeyData)}
                                >
                                  <History className="mr-1.5 h-4 w-4" /> Log Usage
                                </Button>
                              </div>
                            </div>
                          );
